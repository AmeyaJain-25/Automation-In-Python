...
get_id_email.send_keys("ameiya.jain@hotmail.com")   #Sends value to that element or that tag or that object    #enters email id


#Similar fpr password
get_id_password = browserChrome.find_element_by_id("password")
get_id_password.send_keys("ameyalinkedin")
